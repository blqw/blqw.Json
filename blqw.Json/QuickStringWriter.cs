...
namespace blqw.Serializable
{
    ...
    public sealed unsafe class QuickStringWriter : TextWriter
    {
        ...
        /// 
        /// 关闭当前实例
        /// <para> 该行为将清空所有缓冲区中的内容, 并阻止除Ready,Close以外的方法调用,直到再次调用Ready方法 </para>
        /// </summary>
...
#pragma warning restore 649
    ...
    internal struct SBBuffer : ICharBuffer
    {
        ...
        private static readonly unsafe AppendHandler _Append = CreateHandler();
    ...
    internal struct SWBuffer : ICharBuffer
    {
        ...
        public unsafe void Append(char* point, int start, int length)
        {
            if (_Sw == null) _Sw = new StringWriter();
            length = start + length;
